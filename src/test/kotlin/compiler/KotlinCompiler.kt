...
import compiler.KotlinCompiler.Companion.create
  ...
  companion object {
    ...
    fun create(
      ...
      val configuration = CompilerConfiguration().apply {
        ...
        put(CommonConfigurationKeys.MESSAGE_COLLECTOR_KEY, SystemMessageCollector)
        put(IrMessageLogger.IR_MESSAGE_LOGGER, IrMessageCollector(SystemMessageCollector))
        updateConfiguration()
      }
      require(
